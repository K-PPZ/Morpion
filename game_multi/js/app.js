if (document.location.href == "http://127.0.0.1:5173/game_multi/game_multi.html?text=x") {
...
if (document.location.href == "http://127.0.0.1:5173/game_multi/game_multi.html?text=o") {
    let cases = document.getElementsByClassName("cases_morpion");
    let cpu = Math.floor(Math.random() * (8 - 0)) + 0;
    let player_img = document.getElementById("player_img");
